...
router.get(
    '/backups/:backup',
    wrapAsync((req: any, res: any) => backupRemoteUploadController.handle(req, res)),
);
router.post(
    '/backups/:backup',
    wrapAsync((req: any, res: any) => backupStatusController.index(req, res)),
);
router.post(
    '/backups/:backup/restore',
    wrapAsync((req: any, res: any) => backupStatusController.restore(req, res)),
);
