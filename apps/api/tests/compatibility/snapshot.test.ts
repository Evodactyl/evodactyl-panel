...
import { accountSchema, apiKeySchema, locationSchema, nodeSchema, type ObjectSchema, userSchema } from './schemas.js';
...
function validateSchema(data: any, schema: ObjectSchema): string[] {
    ...
    for (const [field, expectedType] of Object.entries(schema.attributes)) {
        ...
        if (!matchesType(value, expectedType)) {
            errors.push(`attributes.${field}: expected ${expectedType}, got ${describeValue(value)}`);
        }
    }
