...
const ENDPOINTS: EndpointDef[] = [
    ...
    {
        method: 'GET',
        path: '/api/application/locations?include=nodes',
        name: 'application-locations-list-include-nodes',
    },
...
async function captureEndpoint(baseUrl: string, method: string, path: string, token: string): Promise<SnapshotResult> {
