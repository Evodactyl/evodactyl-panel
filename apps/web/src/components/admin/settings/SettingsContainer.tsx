...
export default () => {
            ...
            .then((settings) => {
                setInitialValues({
                    ...
                    twoFactorRequirement:
                        twoFactorReverseMap[settings['pterodactyl:auth:2fa_required'] || '0'] || 'not_required',
    ...
    const handleSubmit = (values: SettingsFormValues, { setSubmitting }: any) => {
        ...
        updateSettings(payload)
            .then(() =>
                addFlash({ key: 'admin:settings', type: 'success', message: 'Settings have been saved successfully.' }),
            )
                                ...
                                <div css={tw`grid grid-cols-1 md:grid-cols-3 gap-4 items-start`}>
                                    <div>
                                        <Field
                                            ...
                                            name={'companyName'}
                                            label={'Company Name'}
                                            description={'The name displayed in the page title and navigation.'}
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <div css={tw`flex gap-1 mt-2`}>
                                            {[
                                                ...
                                                <Button
                                                    ...
                                                    size={'small'}
                                                    color={
                                                        values.twoFactorRequirement === opt.value ? 'primary' : 'grey'
                                                    }
                                ...
                                <div css={tw`grid grid-cols-1 md:grid-cols-3 gap-4`}>
                                    ...
                                    <div>
                                        ...
                                        <Select
                                            ...
                                            onChange={(e) => setFieldValue('mailEncryption', e.target.value)}
                                        >
