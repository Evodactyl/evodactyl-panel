import { faLock, faShieldAlt, faUnlock } from '@fortawesome/free-solid-svg-icons';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { useEffect, useState } from 'react';
import { Link, useLocation } from 'react-router-dom';
import useSWR from 'swr';
import tw from 'twin.macro';
import { type AdminUser, getUsers } from '@/api/admin/users';
...
export default () => {
    ...
    }, [users?.pagination.currentPage, users]);
    ...
    const tools = (
        <div css={tw`flex items-center gap-2`}>
            ...
            />
            <Button color={'grey'} size={'xsmall'} onClick={handleSearch}>
                Search
            </Button>
